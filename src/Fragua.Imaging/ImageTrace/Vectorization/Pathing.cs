...
using DirectedEdgeList = System.Collections.Generic.List<Fragua.Imaging.ImageTrace.Vectorization.DirectedEdge>;
using static Fragua.Imaging.ImageTrace.Vectorization.EdgeNode;
using static Fragua.Imaging.ImageTrace.Vectorization.WalkDirection;
